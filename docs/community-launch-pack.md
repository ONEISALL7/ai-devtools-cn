...
```text
当前 npm 公开版本仍是 0.16.1，npm 0.17.0 发布前请先 clone 仓库试用：
...
当前 npm 公开版本仍是 0.16.1，GitHub 最新 release 是 0.17.0。npm 0.17.0 发布前，请优先使用 clone 仓库路径。
...
当前 npm 包还是 0.16.1，npm 0.17.0 发布前先 clone 仓库试用：
...
当前 npm 包还是 0.16.1，npm 0.17.0 发布前建议先 clone 仓库试用：
