...
npm 已发布版本 `0.18.2` 已经支持本发布入口，可以改用：
...
- npm 当前发布版本：`0.18.2`
- GitHub 最新 release：`v0.18.2`
- 外部反馈：已有 1 条公开 feedback issue，并已转化为 pnpm workspace CI 试用包
- 外部 merged PR：目前仍为 0
- npm 发布同步：GitHub release、`package.json` 和 npm 公开包已同步到 `0.18.2`
...
npx ai-devtools-cn@latest handoff --output work/external-pr-handoff.md

如果已经选定某个 issue，可以直接生成定向交接包：
npx ai-devtools-cn@latest handoff --issue 45 --output work/handoff-45.md
